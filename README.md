# Group Status Chart gadget

> up.time gadget which charts the element or monitor status for a group.
...
> Compresses everything in the `src/` folder into `target/uptime.GroupStatusChart.zip`. 
